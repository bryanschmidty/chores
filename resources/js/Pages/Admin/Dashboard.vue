            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        ...
                        >
                            <div class="p-6">
                                <div class="text-2xl font-bold text-green-600">{{ stats.available_chores || 0 }}</div>
                                <div class="text-sm text-gray-600">Available Chores</div>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div v-if="todaysChores && todaysChores.length > 0" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-2">
                                <div v-for="assignedChore in todaysChores" :key="assignedChore.id" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <div>
                                        <div class="font-medium">{{ assignedChore.chore?.name }}</div>
                                        <div class="text-sm text-gray-600">Assigned to: {{ assignedChore.assigned_to?.name }}</div>
                                    </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-2">
                                <div v-for="completion in pendingVerifications" :key="completion.id" class="flex items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                    <div>
                                        <div class="font-medium text-yellow-800">{{ completion.assignedChore?.chore?.name }}</div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                >
                                    <div class="text-blue-600 font-medium">Assign Chores</div>
                                    <div class="text-sm text-blue-800">Assign chores to family members</div>
                                </Link>
                                <Link
